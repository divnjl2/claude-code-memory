# Claude Code PreToolUse[Task] Hook
# Injects global parameters into every sub-agent spawn
# Part of claude-code-memory package

$params = @"
=== INHERITED GLOBAL PARAMETERS (AUTO-INJECTED) ===
